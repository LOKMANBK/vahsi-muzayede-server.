...
// Monitoring opsiyoneldir — monitoring.js yoksa sessizce atlar.
let initMonitoring   = async () => {};
let reportError      = () => {};
let shutdownMonitoring = async () => {};
try {
  const mon = await import('./utils/monitoring.js');
  initMonitoring    = mon.initMonitoring    ?? initMonitoring;
  reportError       = mon.reportError       ?? reportError;
  shutdownMonitoring = mon.shutdownMonitoring ?? shutdownMonitoring;
} catch { /* monitoring.js yok, devam et */ }
